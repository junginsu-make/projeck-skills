...
| M1 (FEAT-0 공통흐름) | Phase 1 | `Phase 1, T1.1` ~ `Phase 1, T1.3` |
...
## 3. Quality Gate (병합 전 필수!)

**모든 태스크 완료 시 Quality Gate를 통과해야 합니다.**
...
|         - [ ] 인수 조건 체크리스트                                   |
|                                                                     |
|  [ ] 3. 의존성 있는 태스크에 Mock 설정이 포함되었는가?               |
|                                                                     |
|  [ ] 4. 각 태스크가 독립적으로 실행 가능한가?                        |
|                                                                     |
|  [ ] 5. 병렬 실행 가능 태스크 테이블이 있는가?                       |
|                                                                     |
|  [ ] 6. 의존성 그래프(Mermaid)가 있는가?                             |
|                                                                     |
+---------------------------------------------------------------------+
```
...
| Phase | 병렬 가능 태스크 | 이유 |
|-------|-----------------|------|
| Phase 1 | T1.1, T1.2 | BE/FE 독립 개발 (Mock 사용) |
| Phase 2 | T2.1, T2.2 | 계약 기반 독립 개발 |
```
